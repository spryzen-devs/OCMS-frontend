...
function AdminD() {
    ...
    const handleSubmit = async(e) => {
        e.preventDefault();
        try{
            await axios.post("https://ocms-backend-576v.onrender.com/courses/add",{
            title : title,
    ...
    useEffect(() => {
        const fetchCourses = async () => {
            try {
                const response = await axios.get(`https://ocms-backend-576v.onrender.com/courses/getAll/${user.id}`);
